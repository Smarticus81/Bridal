...
export const REQUIRED_DATABASE_COLUMNS = {
  ...
  dress_media: ["id", "dress_id", "object_key", "coverage", "display_order", "created_at"],
  lookbooks: [
    "id",
    "organization_id",
    "shop_id",
  ...
  lookbook_dresses: ["id", "lookbook_id", "dress_id", "display_order"],
  reactions: [
    "id",
    "session_id",
    "generated_asset_id",
...
export const REQUIRED_DATABASE_NOT_NULL_COLUMNS = {
  ...
  dress_media: ["id", "dress_id", "object_key", "coverage", "display_order", "created_at"],
  // credit_cap and expires_at NOT NULL enforce "never uncapped, never unexpiring".
  lookbooks: [
    "id",
    "organization_id",
    "shop_id",
  ...
  lookbook_dresses: ["id", "lookbook_id", "dress_id", "display_order"],
  reactions: ["id", "session_id", "generated_asset_id", "voter_token", "kind", "created_at"],
  leads: ["id", "organization_id", "shop_id", "email", "source", "created_at"],
  consent_records: ["id", "subject_email", "consent_type", "affirmative", "consented_at"],
...
export const REQUIRED_DATABASE_INDEXES = [
  ...
  {
    table: "dresses",
    name: "dresses_org_sku_unique",
    label: "dresses.organization_id_sku.unique",
    requiredFragments: ["unique", "organization_id", "sku"],
  },
  {
    table: "dress_media",
    name: "dress_media_dress_object_key_unique",
    label: "dress_media.dress_id_object_key.unique",
    requiredFragments: ["unique", "dress_id", "object_key"],
  },
  {
    table: "lookbooks",
    label: "lookbooks.token.unique",
    requiredFragments: ["unique", "token"],
  },
  {
    table: "lookbook_dresses",
    name: "lookbook_dresses_lookbook_dress_unique",
    label: "lookbook_dresses.lookbook_id_dress_id.unique",
    requiredFragments: ["unique", "lookbook_id", "dress_id"],
  },
  {
    table: "reactions",
    name: "reactions_asset_voter_unique",
    label: "reactions.generated_asset_id_voter_token.unique",
    requiredFragments: ["unique", "generated_asset_id", "voter_token"],
  },
] as const;
